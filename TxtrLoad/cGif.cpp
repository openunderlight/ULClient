...
cGif::cGif(char *filename, short flip)
{
	FILE *pic;
	byte *GifData;
	int filesize;
...
//	  if (DEBUG) fprintf(stderr,"GIF89 aspect = %f\n", normaspect);
	...
	if (HasColormap) {
		//if (Verbose)
		//printf("gif is %dx%d, %d bits per pixel, (%d colors).\n",
	...
	//if (Verbose)
	//printf("Reading a %d by %d %sinterlaced image...",
