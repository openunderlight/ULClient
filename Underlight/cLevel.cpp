...
void cLevel::CreateEdgeSet(int v0_start, int v1_start, int v1_end, int hull_index, hull_t& new_hull, bool first_from, bool first_to, int sec1, int sec2, int new_sec)
{
}
