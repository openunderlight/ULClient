...
private:
	...
	WNDPROC	lpfn_richedit1; // pointer to window procedure
	...
	char last_system_message[DEFAULT_MESSAGE_SIZE];
...
public:
	...
	void DisplaySpeech(const TCHAR *text, char *name, int speechType, bool is_player = false);
...
private:
	...
	// The Window Proc for this control must be a friend...
	friend LRESULT WINAPI RichEditWProc1 ( HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam);
};
